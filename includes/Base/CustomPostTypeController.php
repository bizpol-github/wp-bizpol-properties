...
class CustomPostTypeController extends BaseController{
	...
	public function register(){
        ...
        $activate = isset($option['PropertyOwners']) ? $option['PropertyOwners']  : false;
	...
	public function setSubPages(){
        $this->subpages = [
            ...
            'menu_title' => 'CPT Managers',
            'capability' => 'manage_options',
            'menu_slug' => 'bizpol_properties_cpt',
    ...
    public function setSettings(){
        $args = array(
            [
                'option_group' => 'bizpol_properties_plugin_cpt_settings',
                'option_name' => 'bizpol_properties_cpt',
    ...
    public function storeCustomPostTypes(){
    	...
    	foreach($options as $option){
    		$this->custom_post_types[] = array(
				...
				'insert_into_item'      => 'Isnert into '. $option['singular_name'],
