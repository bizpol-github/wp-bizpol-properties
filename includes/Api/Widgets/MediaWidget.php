...
class MediaWidget extends WP_Widget{
	...
	public function __construct(){
		$this->widget_ID = 'bizpol_media_widget';
		$this->widget_name = 'Media Widget';
		$this->widget_options = [
	...
	public function form($instance){
		$title = !empty($instance['title']) ? $instance['title'] : esc_html__('Text', 'bizpol_properties_plugin');
		...
		<p>
			...
			<input type="text" class="widefat image-uploader" id="<?php echo $imageID ?>" name="<?php echo esc_attr($this->get_field_name('image')); ?>" value="<?php echo esc_url($image); ?>" />
